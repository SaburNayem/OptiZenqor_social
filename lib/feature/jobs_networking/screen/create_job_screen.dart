...
class CreateJobScreen extends StatefulWidget {
  const CreateJobScreen({required this.onCreate, super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          _field(
            _benefits,
            'Benefits',
            hint: 'Healthcare, Bonus, Remote stipend',
          ),
          ...
          FilledButton(onPressed: _submit, child: const Text('Publish job')),
        ],
      ),
    );
  }
  ...
  void _submit() {
    ...
    widget.onCreate(
      JobModel(
        ...
        deadlineLabel: _deadline.text.trim().isEmpty
            ? null
            : _deadline.text.trim(),
      ),
    );
