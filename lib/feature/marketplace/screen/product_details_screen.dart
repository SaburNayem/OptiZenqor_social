...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  void initState() {
    super.initState();
    widget.controller.markViewed(widget.productId);
    widget.controller.loadProductInteractions(widget.productId);
  }
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            const Chip(
                              label: Text('Safety guidelines visible'),
                            ),
                            Chip(
                              label: Text(controller.suspiciousScan(product)),
                            ),
                          ],
                        ),
                      ],
                  ...
                  _sectionCard(
                    ...
                    const Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Use in-app messaging for a record of agreements.',
                        ),
                      ],
                    ),
                  ),
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        ActionChip(
                          ...
                          onPressed: () async {
                            final bool updated = await controller
        ...
        bottomNavigationBar: SafeArea(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: OutlinedButton(
                  onPressed: () => _makeOffer(context, controller, product),
            ...
            children: [
              ...
              FilledButton(
                onPressed: () async {
                  ...
                  final bool sent = await controller.sendOffer(
                    product.id,
                    amount,
                  );
                  if (!context.mounted) {
                  ...
                  AppGet.snackbar(
                    'Marketplace',
                    controller.errorMessage ?? 'Unable to send offer.',
                  );
                },
  ...
  void _buyNow(BuildContext context, ProductModel product) {
    if (!widget.controller.checkoutEnabled) {
