          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Icon(Icons.add, color: const Color(0xFF26C6DA).withOpacity(0.8)),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    const Icon(Icons.calendar_today_outlined, size: 16, color: Color(0xFF26C6DA)),
                ...
                Row(
                  children: [
                    const Icon(Icons.location_on_outlined, size: 16, color: Color(0xFF26C6DA)),
                    const SizedBox(width: 8),
                    Text(
                      location,
                      style: TextStyle(color: Colors.grey.shade600, fontSize: 13),
                        ...
                        SizedBox(
                          ...
                          child: Stack(
                            children: [
                              CircleAvatar(
                                radius: 14,
                                backgroundImage: NetworkImage(MockData.users[0].avatar),
                              ),
                              Positioned(
                                left: 12,
                                child: CircleAvatar(
                                  radius: 14,
                                  backgroundImage: NetworkImage(MockData.users[1].avatar),
                                ),
                              ),
                              Positioned(
                                left: 24,
                                child: CircleAvatar(
                                  radius: 14,
                                  backgroundImage: NetworkImage(MockData.users[2].avatar),
                                ),
                              ),
                            ],
                          ),
