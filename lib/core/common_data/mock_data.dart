...
class MockData {
  ...
  static final users = <UserModel>[
    const UserModel(
      ...
      profilePreview: 'Creator profile featuring reels, collabs, and featured launches.',
    ...
    const UserModel(
      ...
      profilePreview: 'Business page with campaigns, launches, and page insights.',
    ...
    const UserModel(
      ...
      profilePreview: 'Engineer profile with devlogs, tagged posts, and note replies.',
    ...
    const UserModel(
      ...
      profilePreview: 'Shop profile with handmade drops and tagged product posts.',
    ...
    const UserModel(
      ...
      profilePreview: 'Recruiter profile with open roles, hiring updates, and network signals.',
  ...
  static final reels = <ReelModel>[
    const ReelModel(
      ...
      coverUrl:
          'https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=1000',
      textOverlays: <String>['Hook in 2 sec', 'Show transition', 'End with CTA'],
